...
5. **The composition roots are still too broad.** `src/index.ts` and the
   ...
   pages, Credential Vault pages, Memory Store pages, and the Settings page
   shell out of `App.tsx`; runtime Settings composition moved out of
...
- incremental Console decomposition for Settings data loading, navigation,
  ...
  docs data, section router, Agents pages, Sessions pages, Credential Vault
  pages, Memory Store pages, overview, and shell layout.
