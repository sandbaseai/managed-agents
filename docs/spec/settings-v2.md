...
5. **The composition roots are still too broad.** `src/index.ts` and the
   ...
   pages, Environments pages, Credential Vault pages, Memory Store pages, and
   the Settings page shell out of `App.tsx`; shared metric cards moved into
   common Console components; runtime Settings composition moved out of
...
- incremental Console decomposition for Settings data loading, navigation,
  ...
  Credential Vault pages, Memory Store pages, overview, and shell layout.
