...
import { SettingsApiReference, type ApiReferenceEndpoint } from './components/pages/settings/SettingsApiReference';
...
const API_REFERENCE_DOCS: ApiReferenceEndpoint[] = [
  {
    id: 'sessions-create',
    group: 'Sessions',
